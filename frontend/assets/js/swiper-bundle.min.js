        ...
        update: {
            ...
            updateSlides: function() {
                ...
                if (void 0 !== n) {
                    ...
                    for (var P, k, L, $ = s.slidesPerColumn, I = M / $, O = Math.floor(h / s.slidesPerColumn), A = 0; A < h; A += 1) {
                        ...
                        if (s.slidesPerColumn > 1) {
                            ...
                            if ("row" === s.slidesPerColumnFill && s.slidesPerGroup > 1) {
                                ...
                                "column" === s.slidesPerColumnFill ? (B = A - (G = Math.floor(A / $)) * $,
                                (G > O || G === O && B === $ - 1) && (B += 1) >= $ && (B = 0,
                                G += 1)) : G = A - (B = Math.floor(A / I)) * I;
                    ...
                    if (e.virtualSize = Math.max(e.virtualSize, n) + b,
                    ...
                    v.length !== w && (e.params.watchOverflow && e.checkOverflow(),
        ...
        slide: {
            slideTo: function(e, t, a, i) {
                ...
                if (l.cssMode) {
                    ...
                    if (u && (C = h.scrollWidth - h.offsetWidth - C),
                    0 === t)
